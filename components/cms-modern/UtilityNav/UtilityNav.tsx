    ...
    return (
        <>
            <div className="utility-nav">
                {/* Desktop View */}
                <div className="desktop-only nav-wrapper">
                    ...
                    <div className="center-section">
                        <span>FREE SHIPPING ON $50+ FOR REWARDS MEMBERS</span>
                ...
                {/* Mobile View */}
                <div className="mobile-only mobile-brand-links">
                    <a href="#">GAP</a>
                    <a href="#">OLD NAVY</a>
                    <a href="#">BANANA REPUBLIC</a>
                    <a href="#">ATHLETA</a>
            ...
            <style jsx>{`
                ...
                .mobile-brand-links a:last-child {
                    margin-right: 0;
                }
